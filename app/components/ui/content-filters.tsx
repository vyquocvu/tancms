...
import { Filter, X, Calendar, Search, CheckCircle, Clock, Archive, FileText } from 'lucide-react'
...
const STATUS_OPTIONS = [
  ...
  {
    value: 'SCHEDULED' as ContentStatus,
    label: 'Scheduled',
    icon: Clock,
    ...
    <div className={cn('space-y-4', className)}>
      ...
      <div className='flex items-center justify-between'>
        <div className='flex items-center space-x-2'>
          <Button variant='outline' onClick={() => setIsExpanded(!isExpanded)} className='gap-2'>
                ...
                <div className='space-y-2'>
                  ...
                  <div className='space-y-2'>
                    <Input
                      ...
                      placeholder='From'
                      value={
                        filters.createdRange?.from ? formatDate(filters.createdRange.from) : ''
                      }
                      onChange={e =>
                        updateFilters({
                          createdRange: {
                ...
                <div className='space-y-2'>
                  ...
                  <div className='space-y-2'>
                    <Input
                      ...
                      placeholder='From'
                      value={
                        filters.updatedRange?.from ? formatDate(filters.updatedRange.from) : ''
                      }
                      onChange={e =>
                        updateFilters({
                          updatedRange: {
