    ...
    <div className='space-y-2'>
      ...
      <div className='text-xs text-muted-foreground space-y-1'>
        ...
        <ul className='list-disc list-inside space-y-0.5 ml-2'>
          ...
          <li className={/[a-z]/.test(value) ? 'text-green-600' : ''}>Lowercase letter</li>
          <li className={/[A-Z]/.test(value) ? 'text-green-600' : ''}>Uppercase letter</li>
          <li className={/\d/.test(value) ? 'text-green-600' : ''}>Number</li>
