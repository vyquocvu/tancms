                  ...
                  <div className="ml-4 space-y-2">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleRateLimitChange('maxRequests', parseInt(e.target.value))}
                        className="w-24"
                      />
                    </div>
                    <div>
            ...
            <CardContent>
              <div className="space-y-4">
                {middlewares.map((middleware) => (
                  <div key={middleware.name} className="flex items-start justify-between p-3 border rounded-lg">
